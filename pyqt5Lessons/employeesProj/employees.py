...
class Window(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Employees Widget")
    ...
    def displayFirstRecord(self):
        ...
        self.leftLayout.addRow("", img) #the empty one is to preserve the two columns rule throughout form
...
class UpdateEmployee(QWidget):
    ...
    def mainDesign(self):
        ...
        self.title.setStyleSheet('font-size: 24pt; font-family:Arial ')
        self.imgAdd = QLabel()
    ...
    def layouts(self):
        ...
        self.topLayout.addStretch()
        self.topLayout.setContentsMargins(120, 20, 10, 30) # left, top, right , bottom
...
class AddEmployee(QWidget):
    ...
    def mainDesign(self):
        ...
        self.title.setStyleSheet('font-size: 24pt; font-family:Arial ')
        self.imgAdd = QLabel()
        self.imgAdd.setPixmap(QPixmap("images/person.png"))
        ####
        self.nameLbl=QLabel("Name :")
        self.nameEntry=QLineEdit()
